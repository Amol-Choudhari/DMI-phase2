		...
		<div class="form-style-3 content form-middle">
			<div class="card card-cyan">
				<?php foreach($user_data as $user_data_value) { ?>
					...
					<div class="card-header"><h3 class="card-title"><i class="far fa-id-card"></i> Name</h3></div>
					...
					<div class="card-header"><h3 class="card-title"><i class="fas fa-asterisk"></i> Other Details</h3></div>
					<div class="form-horizontal">
						<div class="card-body">
							<div class="row">
								<div class="col-md-4">
					...
					<div class="card-header"><h3 class="card-title"><i class="far fa-user-circle"></i> Assigned Roles</h3></div>
					<div class="form-horizontal">
						<div class="card-body">
							<div class="row">
