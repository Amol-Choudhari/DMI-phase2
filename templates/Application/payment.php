...
<?php 
	if ($all_section_status == 1 && ($final_submit_status == 'no_final_submit' || $final_submit_status == 'referred_back')) {
		echo $this->Html->script('application/payment/final_submit_display') ;
	}
	
	if ($final_submit_status != 'no_final_submit') { 
		echo $this->Html->script('application/payment/no_final_submit') ;
	} 

	if ($payment_confirmation_status == 'not_confirmed') { 
		echo $this->Html->script('application/payment/not_confirmed') ;
	} 
?>
