<?php if($process_query == 'Updated' && $final_submit_status != 'no_final_submit'){  ?>
	<div class="col-md-12 p-0" id="comment_reply_box">
						...
						<div class="col-sm-12 p-0">
							<div class="machinery_table">
								...
								<div class="table-format">
											...
											<?php
												...
												foreach($fetch_comment_reply as $comment_reply){
													...
													if(!empty($comment_reply['reffered_back_date'])){ 
														...
														//Below code changed and added on 14-04-2017 by Amol for edit/delete Applicant reply This will show on click of edit button which create session for edit -->
														if($this->getRequest()->getSession()->read('edit_reply_id') != null){ ?>
									...
									<?php //this field is hidden and send max id and model name for edit/delete mo comment by ajax // added on 11-04-2017 by Amol-->
										echo $this->Form->control('reply_max_id', array('type'=>'hidden', 'id'=>'reply_max_id', 'value'=>$reply_max_id, 'label'=>false,));
										echo $this->Form->control('model_name', array('type'=>'hidden', 'id'=>'model_name', 'value'=>$tablename, 'label'=>false,)); 
									?>
								</div>
							</div>
						</div>
		...
		<?php 	//same above conditions for edit/delete options for Reply are applied here with NOT(opposite) operator to show reply box -->
