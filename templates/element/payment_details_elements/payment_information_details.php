<?php 
	echo $this->Form->control('actual_payment', array('type'=>'hidden', 'id'=>'actual_payment', 'value'=>$application_charge, 'label'=>false,));
	echo $this->Form->control('advancepayment', array('type'=>'hidden', 'id'=>'advancepayment', 'value'=>$_SESSION['advancepayment'], 'label'=>false)); 
?>
			...
			<div class="card-footer p-0">
				<ul class="nav flex-column">
					<li class="nav-item row pt-2">
						...
						<span id="error_payment_amount" class="error invalid-feedback"></span>
					</li>
					<li class="nav-item row pt-2">
						...
						<span id="error_payment_transaction_id" class="error invalid-feedback"></span>
					</li>
					<li class="nav-item row pt-2">
					...
					<li class="nav-item row pt-2">
						...
						<span id="error_payment_trasaction_date" class="error invalid-feedback"></span>
					</li>
