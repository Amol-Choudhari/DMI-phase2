		...
		foreach ($all_records as $each_record) { ?>
			<tr>
				...
				<td>
					...
					<?php echo $this->Html->link('', array('controller' => 'masters', 'action'=>'deleteMasterRecord', $each_record['id']),array('class'=>'glyphicon glyphicon-remove delete_office','title'=>'Delete')); ?>
				</td>
			</tr>
	<?php	$sr_no++; } } ?>
</tbody>
