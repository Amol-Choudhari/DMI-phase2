									...
									<div class="form-group row" id="is_surrender_published_docs_block">
										<label for="inputEmail3" class="col-sm-3 col-form-label">Related Document: <span class="cRed">*</span>
											<?php if(!empty($section_form_details[0]['is_surrender_published_docs'])){?>
												<a id="is_surrender_published_docs_value" target="blank" href="<?php echo str_replace("D:/xampp/htdocs","",$section_form_details[0]['is_surrender_published_docs']); ?>">Preview</a>
											<?php } ?>
										</label>
									...
									<div class="form-group row" id="is_cabook_submitted_docs_block">
										<label for="inputEmail3" class="col-sm-3 col-form-label">Related Document: <span class="cRed">*</span>
											<?php if(!empty($section_form_details[0]['is_cabook_submitted_docs'])){?>
												<a id="is_cabook_submitted_docs_value" target="blank" href="<?php echo str_replace("D:/xampp/htdocs","",$section_form_details[0]['is_cabook_submitted_docs']); ?>">Preview</a>
											<?php } ?>
										</label>
										<div class="custom-file col-sm-9">
										...
										<div class="form-group row" id="is_replica_submitted_docs_block">
											<label for="inputEmail3" class="col-sm-3 col-form-label">Related Document: <span class="cRed">*</span>
												<?php if(!empty($section_form_details[0]['is_replica_submitted_docs'])){?>
													<a id="is_replica_submitted_docs_value" target="blank" href="<?php echo str_replace("D:/xampp/htdocs","",$section_form_details[0]['is_replica_submitted_docs']); ?>">Preview</a>
												<?php } ?>
											</label>
											<div class="custom-file col-sm-9">
