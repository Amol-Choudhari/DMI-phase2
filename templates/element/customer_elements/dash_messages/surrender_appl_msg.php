    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissible">
                ...
                Your Application is Surrendered is Approved.
                As this Application is Surrendered the certificate of
                <?php 
                    $split_customer_id = explode('/',$_SESSION['username']); 
                    if ($split_customer_id[1] == 1) {
                        echo "of Authorisation";
                    } elseif ($split_customer_id[1] == 2) {
                        echo "of Printing Permission";
                    } elseif ($split_customer_id[1] == 3) {
                        echo "of Approval of Laboratory";
                    }
                ?> is cancelled by the competent authority dated <?php echo $isSurrender; ?> 
                Applicant do not grade and mark <?php echo $commoditiesDetails ?> commodity/ies under AGMARK.
