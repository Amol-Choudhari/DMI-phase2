...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="sidebar-mini layout-boxed">
		...
		<div class="wrapper">
			<?php echo $this->element('common_side_menus/front_side_menus'); #Side Menu ?>

			<div class="content-wrapper form_layout_wrapper">
				<?php
					echo $this->fetch('content'); #Content
					echo $this->element('layout_elements/form_alerts'); #Form Alerts
				?>
			</div>
			<aside class="control-sidebar control-sidebar-dark"></aside>
		</div>

		<div class="wrapper"><?php echo $this->element('footer_section'); #Footer ?></div>

		<?php if(isset($message) && $message != null){ echo $this->element('message_boxes'); } #Message Box ?>
