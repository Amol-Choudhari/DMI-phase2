...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<body id="top">
		...
		<?php 
			echo $this->element('home-page-elements/home-page-slider'); 

			echo $this->element('home-page-elements/home-page-services'); 
			
			echo $this->element('home-page-elements/home-page-statistics'); //to show DMI statistics on front home page
			
			echo $this->element('home-page-elements/home-page-footer'); 
		?>
	</body>
</html>
