...
class DevsController extends AppController {
	...
	public function getAllInfo(){
		...
		if ($this->request->is('post')) {
			...
			$currPos = $this->DmiAllApplicationsCurrentPositions->find()->select(['current_level','current_user_email_id'])->where(['customer_id'=>$customer_id])->first();
			...
			$dde = array(
				...
				'cus'=>$customer_id,
				'current_level' => $currPos['current_level'],
