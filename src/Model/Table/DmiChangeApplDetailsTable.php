				...
				if(in_array(7,$selectedValues)){
					...
					if ($firm_type==1 || $firm_type==3) {
						$dataArray = array_merge($dataArray,array(
							...
							'selected_commodity'=>htmlentities($forms_data['selected_commodity'], ENT_QUOTES),
						));
						
					} elseif ($firm_type==2) {
						$dataArray = array_merge($dataArray,array(
							'selected_packing_types'=>htmlentities($forms_data['selected_packing_types'], ENT_QUOTES),
						));
